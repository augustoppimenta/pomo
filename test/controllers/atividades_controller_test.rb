...
class AtividadesControllerTest < ActionController::TestCase
  ...
  test "should create atividade" do
    assert_difference('Atividade.count') do
      post :create, atividade: { data_de_exec: @atividade.data_de_exec, pomodoro: @atividade.pomodoro, titulo: @atividade.titulo }
    end
  ...
  test "should update atividade" do
    patch :update, id: @atividade, atividade: { data_de_exec: @atividade.data_de_exec, pomodoro: @atividade.pomodoro, titulo: @atividade.titulo }
    assert_redirected_to atividade_path(assigns(:atividade))
  end
